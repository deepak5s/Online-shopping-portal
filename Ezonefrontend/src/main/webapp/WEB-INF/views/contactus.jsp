		...
		<div class="row">
			...
			<div class="col-md-4">
				<form>
					...
					<address>
						<strong>INDUS, Inc.</strong><br> SALT CITY,GHAZIABAD<br>
						Silicon Valley, CA India<br> <abbr title="Phone"> P:</abbr>
						(123) 456-7890
					</address>
					<address>
						<strong>Full Name</strong><br> <a href="mailto:#">first.last@indus.com</a>
					</address>
				</form>
			</div>
		</div>
